...
@section('content')
@section('page_title', 'Paket Umroh')
...
<div class="relative py-20"
    ...
    <div class="container relative z-10 text-center text-white">
        <h1 class="text-4xl md:text-5xl font-bold mb-4 font-serif">Paket Umroh</h1>
        <p class="text-sky-100 text-lg max-w-2xl mx-auto">
            Pilih paket Umroh terbaik untuk perjalanan spiritual Anda dengan fasilitas premium dan pelayanan profesional
        </p>
    </div>
</div>
...
<section class="section bg-sky-50">
    <div class="container">
        <div class="card bg-white p-6 rounded-xl shadow-sm mb-8">
            <form method="GET" action="{{ route('packages.umroh') }}" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div>
